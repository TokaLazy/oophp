...
class Member
{
    ...
    {
        $db = Db::getInstance();
        $req = $db->prepare("SELECT * FROM ".self::$table." WHERE $cell = :$cell");
    ...
    {
        $db = Db::getInstance();
        $req = $db->prepare("SELECT * FROM ".self::$table." WHERE id = :id AND $cell = :$cell");
        $req->bindValue(":id", $id);
        $req->bindValue(":$cell", $value);
        $req->execute();
    ...
    {
        $db = Db::getInstance();
        $req = $db->prepare("SELECT id FROM ".self::$table." WHERE pseudo = :pseudo");
    ...
    {
        $db = Db::getInstance();
        $req = $db->prepare("INSERT INTO ".self::$table."
    ...
    {
        $db = Db::getInstance();
        $req = $db->prepare("UPDATE ".self::$table."
        SET pseudo = :pseudo, password = :password, email = :email, avatar = :avatar, website = :website, localisation = :localisation, signature = :signature, token = :token, cookie = :cookie, visite = NOW()
        WHERE id = :id");
        $req->bindValue(':pseudo', $member->pseudo(), PDO::PARAM_STR);
        $req->bindValue(':password', $member->password(), PDO::PARAM_STR);
        $req->bindValue(':email', $member->email(), PDO::PARAM_STR);
        $req->bindValue(':avatar', $member->avatar(), PDO::PARAM_STR);
        $req->bindValue(':website', $member->website(), PDO::PARAM_STR);
